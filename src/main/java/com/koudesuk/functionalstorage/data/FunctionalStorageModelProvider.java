                ...
                for (java.util.Map.Entry<com.koudesuk.functionalstorage.util.DrawerType, java.util.List<Block>> entry : FunctionalStorageBlocks.DRAWER_TYPES
                        ...
                        for (Block block : entry.getValue()) {
                                if (block instanceof com.koudesuk.functionalstorage.block.DrawerBlock drawerBlock) {
                                        ...
                                        com.koudesuk.functionalstorage.util.IWoodType woodType = drawerBlock
                                                        .getWoodType();
                                        ...
                                        TextureMapping mapping = new TextureMapping()
                                                        ...
                                                        .put(front,
                                                                        ResourceLocation.fromNamespaceAndPath(
                                                                                        ...
                                                                                        "block/" + woodName + "_front_"
                                                                                                        + type.getSlots()))
                                                        .put(side, ResourceLocation.fromNamespaceAndPath(
                                                                        "functionalstorage",
                                                                        "block/" + woodName + "_side"));

                                        ModelTemplate template = new ModelTemplate(Optional.of(parent),
                                                        Optional.empty(),
                                        ...
                                        ResourceLocation lockedModelLocation = ResourceLocation.fromNamespaceAndPath(
                                        ...
                                        blockStateGenerator.blockStateOutput.accept(MultiVariantGenerator
                                                        ...
                                                        .with(BlockModelGenerators.createBooleanModelDispatch(
                                                                        com.koudesuk.functionalstorage.block.DrawerBlock.LOCKED,
                                                                        lockedModelLocation,
                                                                        modelLocation))
