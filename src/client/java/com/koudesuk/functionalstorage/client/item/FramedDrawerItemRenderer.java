...
public class FramedDrawerItemRenderer implements BuiltinItemRendererRegistry.DynamicItemRenderer {
    ...
    private void renderWithCustomTextures(PoseStack matrices, VertexConsumer vertexConsumer,
        ...
        for (Direction direction : new Direction[] { null, Direction.DOWN, Direction.UP,
            ...
            for (BakedQuad quad : quads) {
                ...
                TextureAtlasSprite newSprite = getReplacementSprite(quad, modelData, random);
     ...
     */
    private TextureAtlasSprite getReplacementSprite(BakedQuad quad,
    ...
    private String determineModelPart(BakedQuad quad) {
        String spritePart = determineModelPart(quad.getSprite().contents().name().toString());
